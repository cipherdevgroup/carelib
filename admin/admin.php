...
add_action( 'load-post.php',     'carelib_admin_load_post_meta_boxes' );
add_action( 'load-post-new.php', 'carelib_admin_load_post_meta_boxes' );
 ...
 * @return void
 */
function carelib_admin_load_post_meta_boxes() {
