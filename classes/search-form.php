...
class CareLib_Search_Form {
	...
	protected function get_label() {
		$label = carelib()->get_prefix() . '_search_form_label', __( 'Search site', 'carelib' ) );
	...
	protected function get_input() {
		...
		$placeholder = carelib()->get_prefix() . '_search_text', __( 'Search this website', 'carelib' ) );
	...
	protected function get_button() {
		return sprintf(
			...
			esc_attr( carelib()->get_prefix() . '_search_button_label', __( 'Search', 'carelib' ) ) ),
			esc_attr( carelib()->get_prefix() . '_search_button_text', __( 'Search', 'carelib' ) ) )
		);
	}
