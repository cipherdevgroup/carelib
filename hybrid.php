...
if ( ! class_exists( 'Hybrid', false ) ) {
	...
	class Hybrid {
		...
		public function extensions() {
			carelib_require_if_theme_supports( 'breadcrumb-trail', HYBRID_EXT . 'breadcrumb-trail.php' );
			carelib_require_if_theme_supports( 'get-the-image',    HYBRID_EXT . 'get-the-image.php'    );
		}
