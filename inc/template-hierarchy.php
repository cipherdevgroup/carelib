...
add_filter( 'date_template', 'carelib_date_template', 5 );

# Filter the author/user template.
add_filter( 'author_template', 'carelib_user_template', 5 );
...
add_filter( 'attachment_template', 'carelib_singular_template', 5 );
 ...
 */
function carelib_date_template( $template ) {
	$templates = array();
 ...
 * @return string
 */
function carelib_user_template( $template ) {
	$templates = array();
