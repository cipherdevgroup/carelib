...
add_filter( 'carelib_archive_description', array( $GLOBALS['wp_embed'], 'run_shortcode' ),   5  );
add_filter( 'carelib_archive_description', array( $GLOBALS['wp_embed'], 'autoembed'     ),   5  );
add_filter( 'carelib_archive_description',                              'wptexturize',       10 );
add_filter( 'carelib_archive_description',                              'convert_smilies',   15 );
add_filter( 'carelib_archive_description',                              'convert_chars',     20 );
add_filter( 'carelib_archive_description',                              'wpautop',           25 );
add_filter( 'carelib_archive_description',                              'do_shortcode',      30 );
add_filter( 'carelib_archive_description',                              'shortcode_unautop', 35 );
...
add_filter( 'comment_reply_link',             'carelib_comment_reply_link_filter',      5 );
add_filter( 'get_avatar',                     'carelib_get_avatar',                     5 );
add_filter( 'post_thumbnail_html',            'carelib_post_thumbnail_html',            5 );
add_filter( 'comments_popup_link_attributes', 'carelib_comments_popup_link_attributes', 5 );
 ...
 * @return string
 */
function carelib_comment_reply_link_filter( $link ) {
 ...
 * @return string
 */
function carelib_post_thumbnail_html( $html ) {
 ...
 * @return string
 */
function carelib_comments_popup_link_attributes( $attr ) {
