...
class CareLib_Context {
	...
	protected function wp_hooks() {
		add_filter( 'body_class',    array( $this, 'body_class_filter' ), 0, 2 );
		add_filter( 'post_class',    array( $this, 'post_class_filter' ), 0, 3 );
		add_filter( 'comment_class', array( $this, 'comment_class_filter' ), 0, 3 );
	}
