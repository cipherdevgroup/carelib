 ...
 * @return void
 */
function carelib_media_meta( $property, $args = array() ) {
	echo carelib_get_media_meta( $property, $args );
}
 ...
 * @return string
 */
function carelib_get_media_meta( $property, $args = array() ) {
	...
	$meta = carelib_media_meta_factory()->get_media_meta( $args['post_id'] )->get( $property );
 ...
 * @return object
 */
function carelib_media_meta_factory() {
	return CareLib_Media_Meta_Factory::get_instance();
}
 ...
 * @return array
 */
function carelib_get_attachment_types( $post_id = 0 ) {
 ...
 * @return string
 */
function carelib_get_attachment_type( $post_id = 0 ) {
	return carelib_get_attachment_types( $post_id )->type;
}
 ...
 * @return string
 */
function carelib_get_attachment_subtype( $post_id = 0 ) {
	return carelib_get_attachment_types( $post_id )->subtype;
}
 ...
 * @return bool
 */
function carelib_attachment_is_audio( $post_id = 0 ) {
	return 'audio' === carelib_get_attachment_type( $post_id );
}
 ...
 * @return bool
 */
function carelib_attachment_is_video( $post_id = 0 ) {
	return 'video' === carelib_get_attachment_type( $post_id );
}
 ...
 * @return string
 */
function carelib_get_image_size_links() {
 ...
 * @return string
 */
function carelib_get_audio_transcript( $post_id = 0 ) {
	return carelib_get_media_meta( 'lyrics', array( 'wrap' => '', 'post_id' => $post_id ? $post_id : get_the_ID() ) );
}
 ...
 * @return void
 */
function carelib_attachment() {

	$type = carelib_get_attachment_type();

	$attachment = function_exists( "carelib_{$type}_attachment" ) ? call_user_func( "carelib_{$type}_attachment", get_post_mime_type(), wp_get_attachment_url() ) : '';

	echo apply_filters( 'carelib_attachment', apply_filters( "carelib_{$type}_attachment", $attachment ) );
}
 ...
 * @return string
 */
function carelib_application_attachment( $mime = '', $file = '' ) {
 ...
 * @return string
 */
function carelib_text_attachment( $mime = '', $file = '' ) {
	$embed_defaults = wp_embed_defaults();
 ...
 * @return string
 */
function carelib_audio_attachment() {
	return carelib_media_grabber( array( 'type' => 'audio' ) );
}
 ...
 * @return string
 */
function carelib_video_attachment() {
	return carelib_media_grabber( array( 'type' => 'video' ) );
}
