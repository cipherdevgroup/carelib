 ...
 * @return void
 */
function carelib_comment_reply_link( $args = array() ) {
	echo carelib_get_comment_reply_link( $args );
}
 ...
 * @return string
 */
function carelib_get_comment_reply_link( $args = array() ) {
 ...
 * Needs to be used in conjunction with carelib_comments_callback(). Not needed but used just in
 ...
 * @return void
 */
function carelib_comments_end_callback() {
	echo '</li><!-- .comment -->';
}
